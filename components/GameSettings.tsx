...
export default function GameSettings({ lobby, onClose }: Props) {
  ...
  return (
    <div className="mb-6 p-4 rounded-xl bg-party-bg/60 border border-party-border space-y-4 animate-slide-up">
      <h3 className="font-display font-semibold text-white text-sm">ColorRank Settings</h3>
